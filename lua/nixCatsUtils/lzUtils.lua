            ...
            if type(name) == 'string' then
                ...
                if type(path) == 'string' then
                    ...
                    if ok then
                        ...
                        vim.notify(
                            '"packadd ' .. name .. '" failed, and path provided by custom load function (if provided) was not a string\n' .. err,
                            vim.log.levels.WARN,
                ...
                vim.notify('plugin name was not a string and was instead of value:\n' .. vim.inspect(name), vim.log.levels.WARN, { title = 'nixCatsUtils.load_with_after' })
            end
        end
